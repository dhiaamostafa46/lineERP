...
<div id="kt_app_header" class="app-header no-print d-flex align-items-center" 
     style="height: 64px; background: #ffffff !important; border-bottom: 1px solid #eef2f6 !important; box-shadow: 0 2px 8px rgba(15, 23, 42, 0.03) !important;">
    
    <!--begin::Header container (Pure Flexbox 3-Zone Layout)-->
    <div class="app-container container-fluid d-flex align-items-center justify-content-between w-100 px-4 px-lg-8" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="d-flex align-items-center d-lg-none">
                <button type="button" 
                        class="btn btn-icon btn-sm w-36px h-36px rounded-3 border" 
            ...
            <div class="dropdown">
                <button type="button" 
                        class="btn btn-sm d-flex align-items-center gap-2 px-3 py-1 rounded-3 border transition-all"
                        style="background: #f8fafc; border-color: #e2e8f0 !important; color: #0f172a; height: 38px;"
                        data-bs-toggle="dropdown" 
                        aria-expanded="false"
                        onmouseover="this.style.background='#f1f5f9'; this.style.borderColor='#cbd5e1';"
                        onmouseout="this.style.background='#f8fafc'; this.style.borderColor='#e2e8f0';">
                    <div class="d-flex align-items-center justify-content-center rounded-2" 
                         style="width: 24px; height: 24px; background: rgba(30, 58, 138, 0.1); color: #1e3a8a;">
                        <i class="fas fa-store fs-8"></i>
                    </div>
                    <div class="d-flex flex-column text-start">
                        <span class="fs-9 text-muted fw-bold text-uppercase" style="font-size: 9.5px !important; line-height: 1;">@lang('models/Branches.singular')</span>
                        <span class="fs-7 fw-bold text-truncate" style="max-width: 140px; color: #0f172a; line-height: 1.2;">
                            {{ $currentBranch?->name ?? __('lang.all_branches') }}
                        </span>
                    </div>
                    <i class="fas fa-chevron-down fs-9 text-muted ms-1" style="font-size: 9px !important;"></i>
                </button>
        ...
        <!-- ============================================================== -->
        <!-- ZONE 2: CENTER (Live Real-Time Clock & Date + Quick Search)   -->
        <!-- ============================================================== -->
        <div class="d-flex align-items-center gap-3">
            
            <!--begin::Live Real-Time Date & Clock Badge-->
            <div class="d-none d-md-flex align-items-center gap-3 px-3 py-1 rounded-3 border" 
                 style="background: #f8fafc; border-color: #e2e8f0 !important; color: #0f172a; height: 38px;"
                 x-data="{
                     time: '',
                     date: '',
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span class="fs-8 fw-semibold text-gray-800" x-text="date"></span>
                </div>
            ...
            <div class="header-search-box position-relative d-none d-xl-block" style="width: 250px;">
                <i class="fas fa-search position-absolute top-50 translate-middle-y ms-3 fs-8 text-muted"></i>
                <input type="text" 
                       id="globalHeaderSearch"
                       class="form-control form-control-sm rounded-pill ps-9 pe-8 fs-8 border" 
                       placeholder="@lang('lang.search')..." 
                       style="background: #f8fafc; border-color: #e2e8f0 !important; color: #0f172a; height: 38px; transition: all 0.2s ease;"
                ...
                <span class="position-absolute top-50 translate-middle-y end-0 me-3 px-1 rounded text-muted fs-9" 
                      style="background: #e2e8f0; font-size: 9.5px; font-family: monospace;">⌘K</span>
            </div>
        ...
        <!-- ============================================================== -->
        <!-- ZONE 3: END (Fullscreen + Notifications + User Profile Menu)  -->
        <!-- ============================================================== -->
            ...
            @auth('web')
                <div class="dropdown">
                    ...
                    <div class="cursor-pointer d-flex align-items-center gap-2 p-1 pe-3 rounded-pill border transition-all"
                         data-bs-toggle="dropdown" 
                         aria-expanded="false"
                         style="background: #f8fafc; border-color: #e2e8f0 !important; height: 42px;"
                         onmouseover="this.style.background='#f1f5f9'; this.style.borderColor='#cbd5e1';"
                         onmouseout="this.style.background='#f8fafc'; this.style.borderColor='#e2e8f0';">
                        
                        <!-- Avatar -->
                        <div class="d-flex align-items-center justify-content-center rounded-circle text-white fw-bold shadow-xs" 
                             style="width: 32px; height: 32px; font-size: 12px; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%);">
                        ...
                        <div class="d-none d-lg-flex flex-column text-start">
                            ...
                            <span class="fs-9 text-muted" style="font-size: 10px !important;">{{ $user->roles->first()?->name ?? 'Super Admin' }}</span>
                        </div>
                        
                        <i class="fas fa-chevron-down fs-9 text-muted d-none d-lg-inline ms-1" style="font-size: 9px !important;"></i>
                    </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-xl py-2 rounded-3 border-0 mt-1" 
                        ...
                        <li class="px-4 py-3 border-bottom">
                            <div class="d-flex align-items-center gap-3">
                                <div class="d-flex align-items-center justify-content-center rounded-circle text-white fw-bold shadow-xs" 
                                     style="width: 42px; height: 42px; font-size: 15px; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%);">
                                    {{ mb_substr($user->name ?? 'U', 0, 1, 'utf-8') }}
                                </div>
                                <div class="d-flex flex-column text-truncate">
                                    ...
                                    <span class="badge badge-light-primary fw-bold fs-9 px-2 py-0 mt-1 align-self-start" style="font-size: 9.5px !important;">
                        ...
                        <li class="px-3 pt-3 pb-2">
                            <div class="text-muted fs-9 fw-bold px-1 pb-2 text-uppercase d-flex align-items-center justify-content-between" style="font-size: 10px !important;">
                            ...
                            <div class="d-flex align-items-center justify-content-between p-1 rounded-2 bg-light border">
                                <a href="#" 
                                   ...
                                   data-kt-element="mode" data-kt-value="light" title="Light Mode">
                                    ...
                                    <span class="fs-9 fw-bold">فاتح</span>
                                </a>
                                <a href="#" 
                        ...
                        @can('settings.edit')
                            <li class="px-2">
                                <a href="{{ route('settings.edit', 1) }}" 
                                   class="d-flex align-items-center gap-2 py-2 px-3 rounded-2 fs-7 text-gray-700 text-decoration-none" 
                                   wire:navigate>
