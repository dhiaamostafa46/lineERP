        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <!--begin:Menu sub-->
                        <div
                            class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px d-none">
            ...
            <div class="app-navbar flex-shrink-0">
                <li class="app-navbar-item">
                    <a class="nav-link" onclick="toggleFullScreen()" href="#" role="button">
                        <i class="fas fa-expand-arrows-alt text-primary fs-2"></i>
                    </a>
                </li>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <span class="menu-title position-relative">
                                    ...
                                    <span
                                        ...
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="{{ asset('admin_assets') }}/media/flags/united-states.svg"
                                            alt="" /></span>
                                    @else
                                    <span
                                        class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">@lang('lang.arabic')
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="{{ asset('admin_assets') }}/media/flags/saudi-arabia.svg"
                                            alt="" /></span>
                                    @endif
                                </span>
                            </a>
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('switchLang', 'en') }}" class="menu-link d-flex px-5 active">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('switchLang', 'ar') }}" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ asset('admin_assets') }}/media/flags/saudi-arabia.svg" alt="" />
                                        </span>@lang('lang.arabic')</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu sub-->
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('logout') }}" class="menu-link px-5">@lang('lang.logout')</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
