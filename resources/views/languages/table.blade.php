<div class="card-body p-0">
    <div class="table-responsive">
        <table class="table table-striped gy-7 gs-7" id="languages-table">
            <thead>
            <tr class="fw-semibold fs-6 text-gray-800 border-bottom border-gray-200 ">
                <th>@lang('models/modelVariable.fields.Name')</th>
                <th>@lang('models/modelVariable.fields.Locale')</th>
                <th>@lang('models/modelVariable.fields.Status')</th>
