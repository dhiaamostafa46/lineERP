<div x-cloak x-data="dropzone({
    ...
    @dragover.prevent="onDragover($event)" @drop.prevent="onDrop" class="dz-w-full dz-antialiased dropzone-custom">
    <div
        class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-max-w-3xl dz-justify-center dz-bg-white ">
        @if(! is_null($error))
        ...
        <div class="dz-flex dz-justify-between dz-w-full">
            <label for="upload" class="dz-font-medium dz-text-lg dz-mb-2 dz-text-black">@lang('lang.attachments')</label>
            <div x-show="isLoading" role="status">
                <svg aria-hidden="true"
                    class="dz-w-5 dz-h-5 dz-text-gray-200 dz-animate-spin"
                ...
                <span class="dz-sr-only">@lang('lang.loading')...</span>
            </div>
        </div>
        <div @click="$refs.input.click()"
            ...
            <div>
                <div x-show="!isDragging"
                    class="dz-flex dz-items-center dz-bg-gray-50 dz-justify-center dz-gap-2 dz-py-8 dz-h-full ">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <p class="dz-text-md dz-text-gray-600   my-auto">
                        @lang('lang.drop_here_or')
                        <span class="dz-font-semibold dz-text-black">
                            @lang('lang.browse_files')
                        </span>
                    </p>
                </div>
                <div x-show="isDragging"
                    ...
                    <p class="dz-text-md dz-text-gray-600">@lang('lang.drop_here_to_upload')</p>
                </div>
            </div>
        ...
        <div class="dz-flex dz-flex-wrap dz-gap-x-10 dz-gap-y-2 dz-justify-start dz-w-full dz-mt-5 ">
            ...
            <div
                class="dz-flex dz-items-center dz-justify-between dz-gap-2 dz-border dz-rounded dz-border-gray-200 dz-w-full dz-h-auto dz-overflow-hidden  border border-secondary rounded">
                ...
                <div class="d-flex dz-items-center dz-mr-3">
                    <button type="button" @click="removeUpload('{{ $file['tmpFilename'] }}')"
                        class="btn btn-icon btn-danger">x
                    </button>
                </div>
            </div>
            @endforeach
