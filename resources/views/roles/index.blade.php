    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                @can('roles.create')
                <a class="btn btn-sm btn-primary float-right" href="{{ route('roles.create') }}">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm my-3 ">
                ...
                <div id="kt_docs_card_collapsible" class="collapse">
                    {!! Form::model(request()->all(),['route' => 'roles.index', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                            <!-- Name Field -->
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a class="btn btn-sm   btn-primary float-right" href="{{ route('roles.index') }}">
