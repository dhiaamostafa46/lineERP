        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    <h1>@lang('models/Cities.plural')</h1>
                </h1>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                @can('Cities.create')
                <a class="btn btn-sm btn-primary float-right" href="{{ route('Cities.create') }}">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm my-3 ">
                <div class="card-header collapsible cursor-pointer rotate {{ request()->has('pagination') ? 'active' : 'collapsed' }}"
                    data-bs-toggle="collapse" data-bs-target="#kt_cities_filter"
                ...
                <div id="kt_cities_filter" class="collapse {{ request()->has('pagination') ? 'show' : '' }}">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4 mb-4">
                                ...
                                {!! Form::select(
                                    'area_id',
                                    ['' => __('models/Cities.placeholders.select_area')] + $areas->pluck('name', 'id')->all(),
                                    request('area_id'),
                                    ['class' => 'form-control'],
                                ) !!}
                            </div>
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a class="btn btn-sm btn-primary float-right" href="{{ route('Cities.index') }}">
