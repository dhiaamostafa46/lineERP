...
@section('title', __('hr::models/hr_jobs.plural'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    <h1>@lang('hr::models/hr_jobs.plural')</h1>
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a class="btn btn-sm btn-primary float-right" href="{{ route('hr.jobs.create') }}">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm my-3 ">
                ...
                <div id="kt_docs_card_collapsible" class="collapse {{ request()->has('pagination') ? 'show' : '' }}">
                    {!! Form::open(['route' => 'hr.jobs.index', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                            <!-- Name Field -->
                            <div class="form-group col-sm-4 mb-4">
                                {!! Form::label('name', __('hr::models/hr_jobs.fields.name') . ':') !!}
                            ...
                            <div class="form-group col-sm-4 mb-4">
                                ...
                                ':') !!}
                                {!! Form::select('license_required', $licenses, request('license_required'), ['class' =>
                                'form-control', 'placeholder' => __('hr::lang.select_license')]) !!}
                            </div>
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a class="btn btn-sm btn-danger float-right" href="{{ route('hr.jobs.index') }}">
