<!-- Employee Id Field -->
 <input type="hidden" name="type_page" value="system">
<div class="form-group col-sm-6 mb-3">
    {!! Form::label('employee_id', __('hr::models/hr_advances.fields.employee_id') . ':') !!}
    <x-select2-input name="employee_id" :placeholder="__('hr::lang.select_employee')" :list="$employees" :selected_id="old('employee_id', isset($advance) ? $advance->employee_id : 0)">
    </x-select2-input>
</div>
        ...
        (function() {
            ...
            function calculateAndDisplayMonthlyPayments() {
                ...
                months.forEach((month, index) => {
                    ...
                    deleteBtn.innerHTML = '<i class="ki-duotone ki-trash fs-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>';
