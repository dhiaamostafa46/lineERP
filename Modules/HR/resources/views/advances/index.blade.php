...
@section('title', __('hr::models/hr_advances.plural'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    <h1>@lang('hr::models/hr_advances.plural')</h1>
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a class="btn btn-sm btn-primary float-right" href="{{ route('hr.advances.create') }}">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm my-3 ">
                ...
                <div id="kt_docs_card_collapsible" class="collapse">
                    {!! Form::open(['route' => 'hr.advances.index', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                            <!-- Employee Id Field -->
                            <div class="form-group col-sm-4 mb-3">
                                {!! Form::label('employee_id', __('hr::models/hr_advances.fields.employee_id') . ':')
                                !!}
                            ...
                            <div class="form-group col-sm-4 mb-3">
                                ...
                                {!! Form::number('amount', request('amount'), ['class' => 'form-control']) !!}
                            </div>

                            <!-- Due At Field -->
                            <div class="form-group col-sm-4 mb-3">
                                {!! Form::label('due_at', __('hr::models/hr_advances.fields.due_at') . ':') !!}
                                {!! Form::date('due_at', request('due_at'), ['class' => 'form-control']) !!}
                            </div>
                            <!-- pagination Field -->
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a class="btn btn-sm btn-danger float-right" href="{{ route('hr.advances.index') }}">
