...
@section('title', __('hr::models/hr_archive.plural'))
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        <h1>@lang('hr::models/hr_archive.plural')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                @if (true)
                    <div class="card shadow-sm my-3 ">
                        ...
                        <div id="kt_docs_card_collapsible" class="collapse {{ request()->has('pagination') ? 'show' : '' }}">
                            {!! Form::open(['route' => 'hr.Archive.index', 'method' => 'GET']) !!}
                            <div class="card-body">
                                <div class="row">
                                    <!-- Employee Field -->
                            ...
                            <div class="card-footer py-4">
                                ...
                                <a class="btn btn-sm btn-danger float-right" href="{{ route('hr.Archive.index') }}">
