...
@section('title', __('hr::models/hr_payrolls.plural'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    <h1>@lang('hr::models/hr_payrolls.plural')</h1>
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                @can('hr.payrolls.create')
                @livewire('hr::payrolls.create-btn', key('payrolls_create_btn'))
                @endcan
                {{-- <a class="btn btn-sm btn-primary float-right" href="{{ route('hr.payrolls.create') }}">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm my-3 ">
                ...
                <div id="kt_docs_card_collapsible" class="collapse">
                    {!! Form::open(['route' => 'hr.payrolls.index', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                !!}
                                {!! Form::month('payroll_date', request('payroll_date'), ['class' => 'form-control'])
                                !!}
                            </div>
                            <!-- pagination Field -->
                            <div class="form-group col-sm-4">
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a class="btn btn-sm btn-danger float-right" href="{{ route('hr.payrolls.index') }}">
