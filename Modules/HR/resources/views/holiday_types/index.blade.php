...
@section('title', __('hr::models/hr_holiday_types.plural'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    <h1>@lang('hr::models/hr_holiday_types.plural')</h1>
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        @lang('hr::models/hr_holiday_types.plural')
                    </li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a class="btn btn-sm btn-primary float-right" href="{{ route('hr.holiday_types.create') }}">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm my-3 ">
                ...
                <div id="kt_docs_card_collapsible" class="collapse {{ request()->has('pagination') ? 'show' : '' }}">
                    {!! Form::open(['route' => 'hr.holiday_types.index', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                            <!-- Name Field -->
                            <div class="form-group col-sm-4 mb-4">
                                {!! Form::label('name', __('hr::models/hr_holiday_types.fields.name') . ':') !!}
                                {!! Form::text('name', request('name'), ['class' => 'form-control']) !!}
                            </div>

                            <!-- Status Field -->
                            <div class="form-group col-sm-4 mb-4">
                                {!! Form::label('status', __('hr::models/hr_holiday_types.fields.status') . ':') !!}
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a class="btn btn-sm btn-danger float-right" href="{{ route('hr.holiday_types.index') }}">
            ...
            @endif
            <div class="card">
                @include('hr::holiday_types.table')
            </div>
        </div>
    </div>
    <!--end::Content-->
