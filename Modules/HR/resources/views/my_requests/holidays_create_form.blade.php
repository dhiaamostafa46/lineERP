{!! Form::open(['route' => 'hr.holidays.store', 'files' => true]) !!}
...
<div class="card-body">
    <div class="row">
        ...
        <div class="form-group col-sm-6 mb-3">
            ...
            <x-select2-input name="type_id" :placeholder="__('hr::lang.select_type')" :list="$holiday_types" :selected_id="old('type_id', @optional($holiday)->type_id ?? 0)" :id="'type_id'">
            </x-select2-input>
        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success === true) {
                            $('#remaining_balance').val(response.annual_balance - response.balance || 0);
