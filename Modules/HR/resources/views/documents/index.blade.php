...
@section('title', __('hr::models/hr_documents.plural'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    <h1>@lang('hr::models/hr_documents.plural')</h1>
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a class="btn btn-sm btn-primary float-right" href="{{ route('hr.documents.create') }}">
            ...
            <div class="card shadow-sm my-3 ">
                ...
                <div id="kt_docs_card_collapsible" class="collapse {{ request()->has('pagination') ? 'show' : '' }}">
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a class="btn btn-sm btn-danger float-right" href="{{ route('hr.documents.index') }}">
