...
@section('title', __('hr::models/hr_report_types.AttendanceRecords'))
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        ...
                        <h1> @lang('hr::models/hr_report_types.AttendanceRecords')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            @lang('hr::models/hr_report_types.AttendanceRecords')
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                      ...
                      {!! Form::open(['route' => 'hr.Report.Recordspdf', 'method' => 'GET' , 'target' => '_blank']) !!}
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4 mb-3">
                                        ...
                                        <x-select2-input name="employee_id" :placeholder="__('hr::lang.select_employee')" :list="$employees" :selected_id="request('employee_id')">
                                        </x-select2-input>
                                    </div>
                                    <div class="form-group col-sm-4 mb-3">
                                        {!! Form::label('type_id', __('hr::models/hr_report_types.fields.status') . ':') !!}
                                        <x-select2-input name="type_id" :placeholder="__('hr::models/hr_report_types.fields.status')" :list="$types" :selected_id="request('type_id')">
                                        </x-select2-input>
                                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        @include('hr::report_types.AttendanceRecords.table')
                    </div>
                </div>
            </div>
        </div>
