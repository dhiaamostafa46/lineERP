...
@section('title', __('hr::models/hr_report_types.Contact'))
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        ...
                        <h1> @lang('hr::models/hr_report_types.Contact')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            @lang('hr::models/hr_report_types.Contact')
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container">
                ...
                @if (true)
                    <div class="card shadow-sm my-3 no-print">
                        ...
                        {!! Form::open(['route' => 'hr.Report.Contact', 'method' => 'GET']) !!}
                        <div class="card-body">
                            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        @include('hr::report_types.Contact.table')
                    </div>
                </div>
            </div>
        </div>
