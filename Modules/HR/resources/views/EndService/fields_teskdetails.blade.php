...
<div class="form-group col-sm-6 mb-3 d-none">
    {!! Form::label('hr_task_id', __('hr::models/hr_end_service.fields.title') . ':') !!}
    {!! Form::text('hr_task_id', old('hr_task_id', @optional($Tasts)->id), [
        'class' => 'form-control',
        'placeholder' => __('hr::models/hr_end_service.fields.title'),
    ]) !!}
</div>

<div class="form-group col-sm-6 mb-3 d-none">
    {!! Form::label('employee_id', __('hr::models/hr_end_service.fields.title') . ':') !!}
...
<div class="form-group col-sm-6 mb-3 d-none">
    {!! Form::label('userID', __('hr::models/hr_end_service.fields.title') . ':') !!}
