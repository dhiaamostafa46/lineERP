...
@section('title', __('finance::models/fnc_bond.plural'))
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        <h1>@lang('finance::models/fnc_bond.plural')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            @lang('finance::models/fnc_bond.plural')
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                ...
                <!--begin::Actions-->
                  ...
                  <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    @endcan
                    @can('fnc.bonds.csv')
                        <a type="button" class="icon-btn" href="{{ route('fnc.bonds.csv') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                    ...
                    <!-- أيقونة Excel -->
                    @can('fnc.bonds.excel')
                        <a type="button" class="icon-btn"   href="{{ route('fnc.bonds.excel') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                    ...
                    <!-- أيقونة النسخ -->
                    @can('fnc.bonds.pdf')
                        <a type="button" class="icon-btn"  href="{{ route('fnc.bonds.pdf') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-pdf" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('fnc.bonds.create')
                        <a class="btn btn-sm btn-primary float-right" href="{{ route('fnc.bonds.create') }}">
                ...
                @if (true)
                    <div class="card shadow-sm my-3 " id="card-filter">
                        ...
                        <div id="kt_docs_card_collapsible" class="collapse">
                            {!! Form::open(['route' => 'fnc.bonds.index', 'method' => 'GET']) !!}
                            <div class="card-body">
                                <div class="row">
                                    <!-- Name Field -->
                                    <div class="form-group col-md-4 mb-3">
                                        {!! Form::label('type', __('finance::models/fnc_bond.fields.type') . ':') !!}
                                        <x-select2-input name="type" :placeholder="__('hr::lang.select_type')" :list="$types"
                                            :selected_id="old('type')">
                                        </x-select2-input>
                                    </div>

                                    <div class="form-group col-md-4 mb-3">
                                        {!! Form::label('status', __('finance::models/fnc_bond.fields.status') . ':') !!}
