        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex align-items-center justify-content-between">
            <div class="page-title d-flex flex-column justify-content-center">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-8 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('basicdata.products.index', ['type' => $type]) }}" class="text-muted text-hover-primary" wire:navigate>
            ...
            <!-- Header Actions: Single dedicated Icon-Only Buttons -->
            <div class="d-flex align-items-center gap-2">
                @if(!$isService)
                    @can('basicdata.products.import')
                        <button type="button" 
                                class="btn btn-sm btn-icon btn-light rounded-circle shadow-xs" 
                                title="@lang('crud.import')" 
                                data-bs-toggle="tooltip" 
                                x-on:click="$dispatch('openImportModal')" 
                                onclick="if(window.Livewire) Livewire.dispatch('openImportModal')">
                    ...
                    <div class="front-stat-card">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-1">
                            ...
                            <span class="badge bg-light-dark text-gray-700 front-stat-badge">
                                <i class="fa-solid fa-folder-tree fs-9 me-1"></i> @lang('basicdata::models/db_categories.singular')
                            </span>
                        </div>
                    </div>
                </div>
