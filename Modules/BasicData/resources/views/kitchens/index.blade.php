            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        <h1>@lang('basicdata::models/db_kitchens.plural')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <!--begin::Actions-->
                 <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    @can('basicdata.kitchens.copy')
                        <button type="button" class="icon-btn copy-table" data-target="#db-kitchens-table"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-copy" style="font-size: 14px;"></i>
                        </button>
                    @endcan
                    @can('basicdata.kitchens.csv')
                        <a type="button" class="icon-btn" href="{{ route('basicdata.kitchens.csv') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                    ...
                    @can('basicdata.kitchens.excel')
                        <a type="button" class="icon-btn"   href="{{ route('basicdata.kitchens.excel') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                    ...
                    @can('basicdata.kitchens.pdf')
                        <a type="button" class="icon-btn"  href="{{ route('basicdata.kitchens.pdf') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-pdf" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('basicdata.kitchens.create')
                        <a class="btn btn-sm btn-primary float-right" href="{{ route('basicdata.kitchens.create') }}">
                        ...
                        <div id="kt_docs_card_collapsible" class="collapse">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        {!! Form::label('name', __('basicdata::models/db_kitchens.fields.name') . ':') !!}
                            ...
                            <div class="card-footer py-4">
                                ...
                                <a class="btn btn-sm btn-primary float-right"
                                    href="{{ route('basicdata.kitchens.index') }}">
