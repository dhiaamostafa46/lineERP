...
<head>
    <meta charset="utf-8">
    <title>{{ $name ?? 'Income Statement' }}</title>
    <style>
        ...
        .profit { color: green; font-weight: bold; background-color: #e6f9e6; }
        .loss { color: red; font-weight: bold; background-color: #f9e6e6; }
