...
@section('title', __('accusoft::models/as_tree_account.plural'))
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        <h1>@lang('accusoft::models/as_tree_account.plural')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    @endcan
                    @can('accusoft.TreeAccounts.csv')
                        <a type="button" class="icon-btn   btn-btc" href="{{ route('accusoft.TreeAccounts.csv') }}">
                            <i class="fa-solid fa-file-csv" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    <!-- أيقونة Excel -->
                    @can('accusoft.TreeAccounts.excel')
                        <a type="button" class="icon-btn   btn-btc" href="{{ route('accusoft.TreeAccounts.excel') }}">
                            <i class="fa-solid fa-file-excel" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    <!-- أيقونة النسخ -->
                    @can('accusoft.TreeAccounts.pdf')
                        <a type="button" class="icon-btn   btn-btc" href="{{ route('accusoft.TreeAccounts.pdf') }}">
                            <i class="fa-solid fa-file-pdf" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('accusoft.TreeAccounts.import')
                        <a type="button" class="icon-btn   btn-btc" href="{{ route('accusoft.TreeAccounts.import') }}">
                            <i class="fa-solid fa-file-import" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('accusoft.TreeAccounts.create')
                        <a class="btn btn-sm btn-primary float-right" href="{{ route('accusoft.TreeAccounts.create') }}">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                {{-- @if (true)
                    <div class="card shadow-sm my-3 " id="card-filter">
                        ...
                        <div id="kt_docs_card_collapsible" class="collapse">
                            {!! Form::open(['route' => 'accusoft.TreeAccounts.index', 'method' => 'GET']) !!}
                            <div class="card-body">
                                <div class="row">
                                    <!-- Name Field -->
                                    <div class="form-group col-sm-4">
                                        {!! Form::label('name', __('accusoft::models/as_tree_account.fields.name') . ':') !!}
                ...
                @endif --}}
                <div class="card">
                    @include('accusoft::tree_accounts.table')
                </div>
            </div>
        </div>
        <!--end::Content-->
