    ...
    <div class="d-flex align-items-center" style="padding-left: {{ $level * 1.5 }}rem;">
        ...
        <div class="actions">
            <div class='btn-group btn-group-sm'>
                <a href="{{ route('accusoft.TreeAccounts.show', [$account->id]) }}" class='btn btn-light border-0' title="@lang('crud.view')">
                    <i class="fa-solid fa-eye"></i>
                </a>
                <a href="{{ route('accusoft.TreeAccounts.edit', [$account->id]) }}" class='btn btn-light border-0' title="@lang('crud.edit')">
                    <i class="fa-solid fa-edit"></i>
                </a>
                {!! Form::open(['route' => ['accusoft.TreeAccounts.destroy', $account->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
