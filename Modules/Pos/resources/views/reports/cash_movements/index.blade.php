@extends('layouts.app')
@section('title', __('pos::reports.types.cash_movements'))
@section('styles')
<style>
    @media print {
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">@lang('pos::reports.types.cash_movements')</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                    <li class="breadcrumb-item text-muted">@lang('pos::reports.types.cash_movements')</li>
                </ul>
            </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card shadow-sm my-3" id="card-filter">
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    {!! Form::open(['route' => 'pos.reports.sessions_detailed', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-3 mb-3">
                                {!! Form::label('user_id', __('pos::lang.user') . ':') !!}
                                <x-select2-input name="user_id" :list="$users" :selected_id="request('user_id')" :placeholder="__('invoices::models/inv_reports.filters.all')"></x-select2-input>
                            </div>
                            <div class="form-group col-md-3 mb-3">
                    ...
                    <div class="card-footer py-4">
                        ...
                        @endif
                        <a href="{{ route('pos.reports.cash_movements') }}" class="btn btn-sm btn-btc float-right"><i class="fa-solid fa-circle-xmark me-1"></i></a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
            @if($reports !== null)
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light-success shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h4 class="text-success mb-2">@lang('pos::reports.total_deposits')</h4>
                                <h2 class="fw-bolder">{{ number_format($reports->grand_totals->total_deposits ?? 0, 2) }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card bg-light-danger shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h4 class="text-danger mb-2">@lang('pos::reports.total_withdrawals')</h4>
                                <h2 class="fw-bolder">{{ number_format($reports->grand_totals->total_withdrawals ?? 0, 2) }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header"><h3 class="card-title">@lang('pos::reports.types.cash_movements') <span class="badge badge-light-primary ms-2">{{ $reports->total() }} @lang('lang.record')</span></h3></div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover align-middle">
                                <thead class="bg-light-primary"><tr class="fw-bold text-gray-800">
                                    ...
                                    <th>@lang('pos::lang.amount')</th>
                                    <th>@lang('pos::lang.type')</th>
                                    <th>@lang('pos::lang.amount')</th>
                                ...
                                <tbody>
                                    @forelse($reports as $report)
                                        <tr>
                                            ...
                                            <td>{{ $report->pos_session_id }}</td>
                                            <td>{{ __('pos::lang.' . $report->type) }}</td>
                                            <td><td class="fw-bold text-primary">{{ number_format($report->amount, 2) }}</td></td>
                                            {{ $report->user?->name }}
                                        </tr>
                                    @empty
