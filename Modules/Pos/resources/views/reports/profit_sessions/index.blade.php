@extends('layouts.app')
@section('title', __('pos::reports.types.profit_sessions'))
@section('styles')
<style>
    @media print {
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">@lang('pos::reports.types.profit_sessions')</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                    <li class="breadcrumb-item text-muted">@lang('pos::reports.types.profit_sessions')</li>
                </ul>
            </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card shadow-sm my-3" id="card-filter">
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    {!! Form::open(['route' => 'pos.reports.profit_sessions', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-footer py-4">
                        ...
                        @endif
                        <a href="{{ route('pos.reports.profit_sessions') }}" class="btn btn-sm btn-btc float-right"><i class="fa-solid fa-circle-xmark me-1"></i></a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
            @if($reports !== null)
                ...
                <div class="card shadow-sm">
                    <div class="card-header"><h3 class="card-title">@lang('pos::reports.types.profit_sessions') <span class="badge badge-light-primary ms-2">{{ $reports->total() }} @lang('lang.record')</span></h3></div>
