...
class CreateSalesDebitNoteRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => 'nullable|in:' . implode(',', [SalesInvoice::STATUS_DRAFT, SalesInvoice::STATUS_SUBMITTED]),
            ...
            'parent_id' => 'nullable|exists:sales_invoices,id', // Debit note MUST reference a parent invoice for ZATCA
            'return_reason' => 'required|string|max:1000',     // Reason for adjustment is required for ZATCA
