...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchase_invoices', function (Blueprint $table) {
            ...
            $table->foreignId('parent_id')->nullable()->constrained('purchase_invoices')->nullOnDelete(); // مرجع للفاتورة الأصلية في حال المرتجع
            $table->unsignedBigInteger('from_po_id')->nullable()->index(); // مرجع لأمر الشراء المحول
            ...
            $table->integer('status')->default(1)->comment('draft', 'received', 'partially_paid', 'paid', 'returned', 'partially_returned', 'rejected');
