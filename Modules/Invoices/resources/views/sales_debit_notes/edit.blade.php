...
@section('title', __('crud.edit') . ' ' . __('invoices::messages.debit_notes'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    @lang('crud.edit') @lang('invoices::messages.debit_notes') #{{ $debitNote->invoice_number }}
                </h1>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{ route('invoices.sales_debit.index') }}" class="btn btn-sm btn-secondary">
                    @lang('crud.cancel')
                </a>
            </div>
        </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                {!! Form::model($debitNote, [
                    'route'  => ['invoices.sales_debit.update', $debitNote->id],
                    'method' => 'patch',
                    'files'  => true,
                ]) !!}
                <div class="card-body">
                    <div class="row">
                        @include('invoices::sales_debit_notes.fields')
                    </div>
                </div>
