...
@section('title', __('invoices::models/inv_reports.types.purchase_invoices'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    <h1>@lang('invoices::models/inv_reports.types.purchase_invoices')</h1>
                </h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                    <li class="breadcrumb-item text-muted">@lang('invoices::models/inv_reports.types.purchase_invoices')</li>
                </ul>
            </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card shadow-sm my-3" id="card-filter">
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    {!! Form::open(['route' => 'invoices.reports.purchases', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-footer py-4">
                        ...
                        @endif
                        <a href="{{ route('invoices.reports.purchases') }}" class="btn btn-sm btn-btc float-right"><i class="fa-solid fa-circle-xmark me-1"></i> </a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
            ...
            @if($invoices !== null)
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-3">
                            <div class="card bg-light-primary border border-primary border-dashed p-3 text-center">
                                <span class="fs-7 text-muted fw-bold">@lang('invoices::models/inv_reports.accounting_totals.gross_purchases')</span>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-light-danger border border-danger border-dashed p-3 text-center">
                                <span class="fs-7 text-muted fw-bold">@lang('invoices::models/inv_reports.accounting_totals.purchase_returns')</span>
                ...
                <div class="card shadow-sm">
                    <div class="card-header"><h3 class="card-title">@lang('invoices::models/inv_reports.types.purchase_invoices') <span class="badge badge-light-primary ms-2">{{ $invoices->total() }} @lang('lang.record')</span></h3></div>
                            ...
                            <table class="table table-striped table-bordered table-hover align-middle">
                                ...
                                <tbody>
                                     @forelse($invoices as $inv)
                                         @php $isReturn = $inv->type_inv == \Modules\Invoices\App\Models\PurchaseInvoice::TYPE_RETURN; @endphp
                                         <tr class="{{ $isReturn ? 'table-light-danger' : '' }}">
                                             <td class="text-center">{{ ($invoices->currentPage()-1) * $invoices->perPage() + $loop->iteration }}</td>
                                              ...
                                              <td>{{ $inv->createdBy?->name ?? $inv->user?->name }}</td>
