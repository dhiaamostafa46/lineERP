...
@section('title', __('invoices::models/inv_reports.types.sales_by_customer'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    @lang('invoices::models/inv_reports.types.sales_by_customer')
                </h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                    <li class="breadcrumb-item text-muted">@lang('invoices::models/inv_reports.types.sales_by_customer')</li>
                </ul>
            </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card shadow-sm my-3" id="card-filter">
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    {!! Form::open(['route' => 'invoices.reports.sales_by_customer', 'method' => 'GET']) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4 mb-3">
                                {!! Form::label('customer_id', __('invoices::models/inv_reports.filters.customer') . ':') !!}
                                {!! Form::select('customer_id', [], request('customer_id'), ['class' => 'form-select select2-ajax-customers', 'data-selected' => request('customer_id'), 'placeholder' => __('invoices::models/inv_reports.filters.all_customers')]) !!}
                            </div>
                            <div class="form-group col-md-4 mb-3">
                    ...
                    <div class="card-footer py-4">
                        ...
                        <a href="{{ route('invoices.reports.sales_by_customer') }}" class="btn btn-sm btn-btc float-right"><i class="fa-solid fa-circle-xmark me-1"></i> @lang('crud.reset')</a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
            ...
            @if($data !== null)
                <div class="card shadow-sm">
                    <div class="card-header"><h3 class="card-title">@lang('invoices::models/inv_reports.types.sales_by_customer') <span class="badge badge-light-primary ms-2">{{ $data->count() }} @lang('lang.record')</span></h3></div>
