...
@section('title', __('lang.details') . ' ' . __('invoices::models/sales_return_invoices.singular'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    @lang('lang.details') @lang('invoices::models/sales_return_invoices.singular') #{{ $salesReturn->invoice_number }}
                </h1>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('invoices.sales_return.edit', $salesReturn->id) }}" class="btn btn-sm btn-primary">
                ...
                <a href="{{ route('invoices.sales_return.index') }}" class="btn btn-sm btn-primary">
                    @lang('crud.back')
                </a>
            </div>
        </div>
