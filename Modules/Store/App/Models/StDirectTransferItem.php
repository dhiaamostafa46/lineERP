...
class StDirectTransferItem extends Model
{
    protected $table = 'st_direct_transfer_items';

    protected $fillable = [
        'direct_transfer_id', 'product_id', 'unit_id', 'have_sizes',
        'quantity', 'received_quantity', 'variance_quantity', 'returned_quantity',
        'unit_cost', 'total_cost', 'unit', 'status', 'notes',
    ];
    ...
    {
        return $this->belongsTo(StDirectTransfer::class, 'direct_transfer_id');
    }
