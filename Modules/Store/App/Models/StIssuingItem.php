...
class StIssuingItem extends Model
{
    protected $table = 'st_issuing_items';

    protected $fillable = [
        'issuing_id', 'product_id', 'unit_id', 'have_sizes',
    ...
    {
        return $this->belongsTo(StIssuing::class, 'issuing_id');
    }
