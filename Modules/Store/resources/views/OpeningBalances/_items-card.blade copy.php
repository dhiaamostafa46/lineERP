                ...
                <table class="table custom-table mb-0" id="items-table">
                    <thead>
                        <tr class="text-center bg-light fw-bold">
                            <th>@lang('store::models/st_opening_balances.items.barcode')</th>
            ...
            <div class="row">
                <div class="col-md-4 offset-md-8">
                    <table class="table table-sm table-borderless mb-0">
                        <tbody>
                            <tr>
                                <td class="text-end fw-bold">@lang('store::models/st_opening_balances.fields.total_items')</td>
                                <td class="text-end">
                                    <span id="total-items">0</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-end fw-bold">@lang('store::models/st_opening_balances.fields.total_quantity')</td>
                                <td class="text-end">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const oldItems = @json(old('items', isset($openingBalance) && $openingBalance->items ? $openingBalance->items->toArray() : []));
