...
@section('title', __('store::models/st_settlements.plural') )
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        <h1>@lang('store::models/st_settlements.plural')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            @lang('store::models/st_settlements.plural')
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    @endcan
                    @can('store.settlement.csv')
                        <a type="button" class="icon-btn" href="{{ route('store.settlement.csv') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-csv" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    <!-- أيقونة Excel -->
                    @can('store.settlement.excel')
                        <a type="button" class="icon-btn" href="{{ route('store.settlement.excel') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-excel" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    <!-- أيقونة النسخ -->
                    @can('store.settlement.pdf')
                        <a type="button" class="icon-btn" href="{{ route('store.settlement.pdf') }}" target="_blank"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-pdf" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    <a type="button" class="icon-btn" href="{{ route('store.settlement.import') }}" title="استيراد ذكي"
                        style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                        <i class="fa-solid fa-file-import" style="font-size: 14px;"></i>
                    </a>
                    @can('store.settlement.create')
                        <a class="btn btn-sm btn-primary float-right" href="{{ route('store.settlement.create') }}">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                @if (true)
                    <div class="card shadow-sm my-3 " id="card-filter">
                        ...
                        <div id="kt_docs_card_collapsible" class="collapse">
                            {!! Form::open(['route' => 'store.settlement.index', 'method' => 'GET']) !!}
                            <div class="card-body">
                                <div class="row g-5">
                                    <!-- Document Number Field -->
                                    <div class="form-group col-md-3">
                                        {!! Form::label('document_number', __('store::models/st_settlements.fields.document_number') . ':') !!}
                                        {!! Form::text('document_number', request('document_number'), ['class' => 'form-control form-control', 'placeholder' => __('lang.search')]) !!}
                                    </div>

                                    <!-- Store Field -->
                                    <div class="form-group col-md-3">
                                        {!! Form::label('store_id', __('store::models/st_settlements.fields.store_id') . ':') !!}
                                    ...
                                    <!-- Status Field -->
                                    <div class="form-group col-md-3">
                                        {!! Form::label('status', __('store::models/st_settlements.fields.status') . ':') !!}
                            ...
                            <div class="card-footer py-4 d-flex justify-content-end gap-2">
                                ...
                                <a class="btn btn-sm btn-secondary" href="{{ route('store.settlement.index') }}">
                ...
                @endif
                <div class="card">
                    @include('store::settlements.table')
                </div>
            </div>
        </div>
        <!--end::Content-->
