            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        @lang('store::models/st_receivings.singular') @lang('crud.detail')
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('store.receiving.edit', $receiving->id) }}" class="btn btn-sm btn-primary">
                        @lang('crud.edit')
                    </a>
                    @endif
                    <a class="btn btn-sm btn-secondary float-right" href="{{ route('store.receiving.index') }}">
                        @lang('crud.back')
                    </a>
                </div>
                <!--end::Actions-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            @include('store::receivings.show_fields')
                        </div>
                    </div>
                </div>
            </div>
    ...
    window.addEventListener('DOMContentLoaded', function() {
        ...
        window.onafterprint = function() {
            setTimeout(function() {
                window.close();
                setTimeout(function() {
                    window.location.href = "{{ route('store.receiving.index') }}";
                }, 300);
            }, 100);
        };
