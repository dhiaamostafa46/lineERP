...
@section('title', __('store::models/st_reports.types.stock_balance'))
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                        <li class="breadcrumb-item text-muted">@lang('store::models/st_reports.types.stock_balance')</li>
                    </ul>
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card shadow-sm my-3" id="card-filter">
                    ...
                    <div id="kt_docs_card_collapsible" class="collapse show">
                        {!! Form::open(['route' => 'store.reports.stockBalance', 'method' => 'GET']) !!}
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 mb-3">
                                    {!! Form::label('stock_status', __('store::models/st_reports.filters.product_display') . ':') !!}
                                    {!! Form::select('stock_status', [
                                        'all' => __('store::models/st_reports.filters.all_with_zero'),
                                        'without_zero' => __('store::models/st_reports.filters.without_zero'),
                                        'zero_only' => __('store::models/st_reports.filters.zero_only'),
                                    ], old('stock_status', request('stock_status', 'all')), ['class' => 'form-select']) !!}
                                </div>
                                <div class="form-group col-md-6 mb-3">
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            {!! Form::label('fromDate', __('store::models/st_reports.filters.from_date') . ':') !!}
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::label('toDate', __('store::models/st_reports.filters.to_date') . ':') !!}
                        ...
                        <div class="card-footer py-4">
                            ...
                            @endif
                            <a href="{{ route('store.reports.stockBalance') }}" class="btn btn-sm btn-btc">
                ...
                @if ($stocks !== null)
                    <div class="card shadow-sm">
                        <div class="card-header">
                            <h3 class="card-title">
                                @lang('store::models/st_reports.types.stock_balance')
                                <span class="badge badge-light-success ms-2">{{ $stocks->total() }}
                                ...
                                <table class="table table-striped table-bordered table-hover align-middle">
                                    <thead class="bg-light-success">
                                        <tr class="fw-bold text-gray-800">
                                            ...
                                            <th class="text-center">@lang('store::models/st_reports.columns.opening_quantity')</th>
                                            <th class="text-center">@lang('store::models/st_reports.columns.qty_in')</th>
                                            <th class="text-center">@lang('store::models/st_reports.columns.qty_out')</th>
                                            ...
                                            <th class="text-center">@lang('store::models/st_reports.columns.average_cost')</th>
                                            <th class="text-center">@lang('store::models/st_reports.columns.total_value')</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse($stocks as $i => $stock)
                                            @php $totalVal = $stock->current_quantity * $stock->average_cost; @endphp
                                            <tr>
                                                ...
                                                <td class="text-center text-muted">
                                                    {{ number_format($stock->opening_qty, 2) }}</td>
                                                <td class="text-center text-success">
                                                    {{ number_format($stock->qty_in, 2) }}</td>
                                                <td class="text-center text-danger">
                                                    {{ number_format($stock->qty_out, 2) }}</td>
                                    ...
                                    @if ($stocks->count() > 0)
                                        <tfoot>
                                            <tr class="fw-bold bg-light">
                                                <td colspan="10" class="text-end">@lang('lang.total'):</td>
                                                <td class="text-center fw-bolder text-primary">
                                                    {{ number_format($stocks->sum(fn($s) => $s->current_quantity * $s->average_cost), 2) }}
                                                </td>
                                            </tr>
                                        </tfoot>
                                    @endif
                ...
                @else
                    <div class="card shadow-sm">
                        <div class="card-body text-center py-20">
                            <i class="fa-solid fa-warehouse fs-5x text-muted mb-5 d-block"></i>
