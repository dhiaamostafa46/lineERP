...
@section('title', __('store::models/st_reports.types.inventory_valuation'))
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                        <li class="breadcrumb-item text-muted">@lang('store::models/st_reports.types.inventory_valuation')</li>
                    </ul>
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card shadow-sm my-3" id="card-filter">
                    ...
                    <div id="kt_docs_card_collapsible" class="collapse show">
                        {!! Form::open(['route' => 'store.reports.inventoryValuation', 'method' => 'GET']) !!}
                        ...
                        <div class="card-footer py-4">
                             ...
                             @endif
                             <a href="{{ route('store.reports.inventoryValuation') }}" class="btn btn-sm btn-btc">
                ...
                @if ($data !== null)
                    <div class="card shadow-sm mb-5">
                        <div class="card-body py-5">
                            <div class="row g-5">
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center bg-light-primary rounded p-5 mb-0">
                                        <span class="svg-icon svg-icon-primary me-5">
                                            <i class="fas fa-boxes fa-2x text-primary"></i>
                                        </span>
                                        <div class="flex-grow-1 me-2">
                                            <span
                                                class="fw-bold text-gray-800 text-hover-primary fs-6">@lang('store::models/st_reports.types.inventory_valuation')</span>
                                            <span class="text-muted fw-semibold d-block">{{ $data['stocks']->total() }}
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center bg-light-success rounded p-5 mb-0">
                                        ...
                                        <div class="flex-grow-1 me-2">
                                            <span
                                                class="fw-bold text-gray-800 text-hover-primary fs-6">@lang('store::models/st_reports.columns.total_quantity')</span>
                                            <span
                                                class="text-success fw-bolder d-block fs-4">{{ $data['total_qty'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center bg-light-info rounded p-5 mb-0">
                                        <span class="svg-icon svg-icon-info me-5">
                                            <i class="fas fa-money-bill-wave fa-2x text-info"></i>
                                        </span>
                                        <div class="flex-grow-1 me-2">
                                            <span
                                                class="fw-bold text-gray-800 text-hover-primary fs-6">@lang('store::models/st_reports.columns.total_value')</span>
                                            <span
                                                class="text-info fw-bolder d-block fs-4">{{ $data['total_value'] }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-header">
                            <h3 class="card-title">@lang('store::models/st_reports.plural')</h3>
                        </div>
                        <div class="card-body pt-3">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover align-middle">
                                    ...
                                    <tbody>
                                        @forelse($data['stocks'] as $i => $stock)
                                            <tr>
                                                <td class="text-center">
                                                    {{ ($data['stocks']->currentPage() - 1) * $data['stocks']->perPage() + $loop->iteration }}
                                                </td>
                                                <td>{{ $stock->category_name }}</td>
                                                <td>{{ $stock->product_name }}</td>
                                                <td>{{ $stock->store?->name }}</td>
                                                <td class="text-center fw-bold">
                                                    {{ number_format($stock->current_quantity, 4) }}</td>
                            ...
                            <div class="mt-4">
                                {{ $data['stocks']->appends(request()->all())->links() }}
                            </div>
                        </div>
                    </div>
                @else
                    <div class="card shadow-sm">
                        <div class="card-body text-center py-20">
                            <i class="fa-solid fa-chart-line fs-5x text-muted mb-5 d-block"></i>
