...
@section('title', __('store::models/st_reports.types.inventory_count'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                    <li class="breadcrumb-item text-muted">@lang('store::models/st_reports.types.inventory_count')</li>
                </ul>
            </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card shadow-sm my-3" id="card-filter">
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    {!! Form::open(['route' => 'store.reports.inventoryCount', 'method' => 'GET']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                ...
                                <x-select2-input name="store_id"
                                    :placeholder="__('store::models/st_reports.filters.all_stores')"
                                    :list="$stores"
                                    :selected_id="old('store_id', request('store_id'))">
                                </x-select2-input>
                            </div>
                            <div class="form-group col-md-3 mb-3">
                                {!! Form::label('category_id', __('store::models/st_reports.filters.category') . ':') !!}
                                <x-select2-input name="category_id"
                                    :placeholder="__('store::models/st_reports.filters.all_categories')"
                                    :list="$categories"
                            ...
                            <div class="form-group col-md-3 mb-3">
                                ...
                                <x-select2-input name="product_id" id="product_search_ajax"
                                    :placeholder="__('store::models/st_reports.filters.all_products')"
                                    :list="$products"
                                    :selected_id="old('product_id', request('product_id'))"
                                    data-ajax--url="{{ route('Lookup.getproducts') }}"
                    ...
                    <div class="card-footer py-4">
                        ...
                        @endif
                        <a href="{{ route('store.reports.inventoryCount') }}" class="btn btn-sm btn-btc">
            ...
            @if($stocks !== null)
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title">
                            @lang('store::models/st_reports.types.inventory_count')
                            <span class="badge badge-light-primary ms-2">{{ $stocks->total() }} @lang('lang.record')</span>
                        </h3>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover align-middle">
                                <thead class="bg-light-primary">
                                    <tr class="fw-bold text-gray-800">
                                        ...
                                        <th class="text-center">@lang('store::models/st_reports.columns.book_quantity')</th>
                                        <th class="text-center">@lang('store::models/st_reports.columns.actual_quantity')</th>
                                        <th class="text-center">@lang('store::models/st_reports.columns.difference')</th>
                                        <th>@lang('store::models/st_reports.columns.unit')</th>
                                        <th class="text-center">@lang('store::models/st_reports.columns.last_movement')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse($stocks as $i => $stock)
                                        <tr>
                                            ...
                                            <td class="text-center fw-bold">{{ number_format($stock->current_quantity, 2) }}</td>
                                            <td class="text-center">________</td>
                                            <td class="text-center">________</td>
                                            <td>{{ $stock->unit?->name }}</td>
                                            <td class="text-center">{{ $stock->last_movement_at ? (\Illuminate\Support\Carbon::parse($stock->last_movement_at)->format('Y-m-d')) : '-' }}</td>
                                        </tr>
                                    @empty
                                        <tr>
