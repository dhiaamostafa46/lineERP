...
@section('title', __('store::models/st_damageds.plural') )
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        <h1>@lang('store::models/st_damageds.plural')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    @endcan
                    @can('store.damaged.csv')
                        <a type="button" class="icon-btn" href="{{ route('store.damaged.csv') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-csv" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    <!-- أيقونة Excel -->
                    @can('store.damaged.excel')
                        <a type="button" class="icon-btn" href="{{ route('store.damaged.excel') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-excel" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    <!-- أيقونة النسخ -->
                    @can('store.damaged.pdf')
                        <a type="button" class="icon-btn" href="{{ route('store.damaged.pdf') }}" target="_blank"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-pdf" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('store.damaged.create')
                        <a class="btn btn-sm btn-primary float-right" href="{{ route('store.damaged.create') }}">
                ...
                @if (true)
                    <div class="card shadow-sm my-3 " id="card-filter">
                        ...
                        <div id="kt_docs_card_collapsible" class="collapse">
                            {!! Form::open(['route' => 'store.damaged.index', 'method' => 'GET']) !!}
                            <div class="card-body">
                                <div class="row">
                                    <!-- Document Number Field -->
                                    <div class="form-group col-md-3">
                                        {!! Form::label('document_number', __('store::models/st_damageds.fields.document_number') . ':') !!}
                                    ...
                                    <!-- Store Field -->
                                    <div class="form-group col-md-3">
                                        {!! Form::label('store_id', __('store::models/st_damageds.fields.store_id') . ':') !!}
                                    ...
                                    <!-- Status Field -->
                                    <div class="form-group col-md-3">
                                        {!! Form::label('status', __('store::models/st_damageds.fields.status') . ':') !!}
                            ...
                            <div class="card-footer py-4 d-flex justify-content-end gap-2">
                                ...
                                <a class="btn btn-sm btn-secondary" href="{{ route('store.damaged.index') }}">
