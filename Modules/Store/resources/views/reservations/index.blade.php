...
@section('title', __('store::models/st_reservations.plural') )
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        <h1>@lang('store::models/st_reservations.plural')</h1>
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    @endcan
                    @can('store.reservation.copy')
                        <button type="button" class="icon-btn copy-table" data-target="#reservations-table"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-copy" style="font-size: 14px;"></i>
                        </button>
                    @endcan
                    @can('store.reservation.csv')
                        <a type="button" class="icon-btn" href="{{ route('store.reservation.csv') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-csv" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('store.reservation.excel')
                        <a type="button" class="icon-btn" href="{{ route('store.reservation.excel') }}"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-excel" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('store.reservation.pdf')
                        <a type="button" class="icon-btn" href="{{ route('store.reservation.pdf') }}" target="_blank"
                            style="background-color: transparent; border: 1px solid #cbd5e0; color: #4a5568; border-radius: 6px; padding: 8px 10px; cursor: pointer; transition: all 0.3s;">
                            <i class="fa-solid fa-file-pdf" style="font-size: 14px;"></i>
                        </a>
                    @endcan
                    @can('store.reservation.create')
                        <a class="btn btn-sm btn-primary float-right" href="{{ route('store.reservation.create') }}">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card shadow-sm my-3 " id="card-filter">
                    ...
                    <div id="kt_docs_card_collapsible" class="collapse">
                        {!! Form::open(['route' => 'store.reservation.index', 'method' => 'GET']) !!}
                        <div class="card-body">
                            <div class="row">
                                <!-- Document Number Field -->
                                <div class="form-group col-md-3">
                                    {!! Form::label('document_number', __('store::models/st_reservations.fields.document_number') . ':') !!}
                                    {!! Form::text('document_number', request('document_number'), ['class' => 'form-control form-control', 'placeholder' => __('lang.search')]) !!}
                                </div>
                                <!-- Store Field -->
                                <div class="form-group col-md-3">
                                    {!! Form::label('store_id', __('store::models/st_reservations.fields.store_id') . ':') !!}
                                ...
                                <!-- Status Field -->
                                <div class="form-group col-md-3">
                                    {!! Form::label('status', __('store::models/st_reservations.fields.status') . ':') !!}
                        ...
                        <div class="card-footer py-4 d-flex justify-content-end gap-2">
                            ...
                            <a class="btn btn-sm btn-secondary" href="{{ route('store.reservation.index') }}">
                ...
                <div class="card">
                    @include('store::reservations.table')
                </div>
            </div>
        </div>
        <!--end::Content-->
