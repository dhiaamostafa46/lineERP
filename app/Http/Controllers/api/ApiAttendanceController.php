...
class ApiAttendanceController extends Controller
{
    ...
    public function getAttendance($lang,Request $request)
    {
    ...
    public function checkIn($lang,ApiAttCheckInRequest $request)
    {  
        app()->setLocale($lang);
     ...
     public function getShift($lang)
    {
        ...
        return response()->json([
            ...
            "shifts"=>$shits,
            "early_entry"=>$records->early_entry,
            "late_entry"=>$records->late_entry,
            "early_exit"=>$records->early_exit,
            "late_exit"=>$records->late_exit,
            "entry_end_time" =>$records->entry_end,
            "exit_start_time"=>$records->exit_start,
