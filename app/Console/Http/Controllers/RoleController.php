...
class RoleController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $excludedPermissions = config('hidepermission.permissions'); // تأكد من وجود المفتاح 'permissions' هنا
    ...
    public function update($id, UpdateRoleRequest $request)
    {
        ...
        $existingPermissions = \Spatie\Permission\Models\Permission::whereIn('name', $request->permissions)->pluck('name')->toArray();
